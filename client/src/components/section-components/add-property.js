...
const AddProperty = (props) => {
  ...
  useEffect(() => {
    if (types == "rent") {
      setBuildingType("Rent");
    }
    if (types == "sale") {
      setBuildingType("Sale");
    }
  }, [types]);
  ...
  useEffect(() => {
    ...
    if (listingType === "Add") {
      ...
      console.log("buildingggggggggggggggg", singleProperty?.buildingType);
      console.log("housinggggggggggggggggg", singleProperty?.houseType);
      console.log("singleProperty>>>>>ssss", singleProperty);
      setType("PUT");
      ...
      setDateForRent(singleProperty?.dateForRent);
      setCommunity(singleProperty?.community);
  ...
  const [buildingType, setBuildingType] = useState(types);
  ...
  const forRoofingType = [
    { value: "Ashpalt Shingle,", label: "Ashpalt Shingle," },
  ...
  const Appliances = [
    ...
    {
      label: buildingType === "Rent" ? "Wall Oven" : null,
      value: buildingType === "Rent" ? "Wall Oven" : null,
    },
    {
      label: buildingType === "Rent" ? "CookTop" : null,
      value: buildingType === "Rent" ? "CookTop" : null,
    },
  ];
  const Basement = [
  ...
  const handleAppliances = (val) => {
    console.log("handleAppliance", val);
    setAppliances(val);
  };
  ...
  const handleNext = () => {
    ...
    if (buildingType == "") {
      ...
      window.scrollTo(0, 0);
      if (buildingType == "Rent" && activeStep == 2) {
        setActiveStep((prevActiveStep) => prevActiveStep + 1);
      }
      setKey(false);
  ...
  const handleBack = () => {
    setActiveStep((prevActiveStep) => prevActiveStep - 1);
    if (buildingType == "Rent" && activeStep == 4) {
      setActiveStep((prevActiveStep) => prevActiveStep - 1);
    }
  };
        ...
        return (
          <div className="row ">
            ...
            <div className="col-sm-6 col-md-6 col-lg-6 col-12">
              <label className="single-input-inner style-bg-border">
                <h5 className="label">
                  Basement<span style={{ color: " #dad6d6" }}>-optional</span>
                </h5>
                {/* <Select
                  isMulti
                  styles={customStyles}
            ...
            {buildingType == "Rent" ? (
              <div className="col-sm-6 col-md-6 col-lg-6 col-12">
                <label className="single-input-inner style-bg-border">
                  <h5 className="label">
                    Pets<span style={{ color: " #dad6d6" }}>-optional</span>
                  </h5>
                  <Select
                    styles={customStyles}
                    options={forFrontType}
                    onChange={handleFrontType}
                    defaultValue={forFrontType.filter(
                      ({ value }) => value === frontType
                    )}
                  />
                </label>
              </div>
        ...
        return (
          <div className="row">
            ...
            <div className="col-sm-6 col-md-6 col-lg-6 col-12">
              <label className="single-input-inner style-bg-border">
                <h5 className="label">
                  Hydro Gas<span style={{ color: " #dad6d6" }}>-optional</span>
                </h5>
                <Select
                  styles={customStyles}
                  options={forViewType}
        ...
        return (
          <>
            ...
            <div className="row">
              ...
              <div className="col-sm-6 col-md-6 col-lg-6 col-12">
                <label className="single-input-inner style-bg-border">
                  <h5 className="label">Property Tax Year</h5>
                  <input
                    type="number"
              ...
              <div className="col-sm-6 col-md-6 col-lg-6 col-12">
                <label className="single-input-inner style-bg-border">
                  <h5 className="label">Association/POTL Fee</h5>
                  <input
                    type="number"
                    placeholder="Association/POTL Fee"
              ...
              <div className="col-sm-6 col-md-6 col-lg-6 col-12">
                <label className="single-input-inner style-bg-border">
                  <h5 className="label">Assessment Amount</h5>
                  <input
                    type="number"
              ...
              <div className="col-sm-12 col-md-12 col-lg-12 col-12">
                <label className="single-input-inner style-bg-border">
                  <h5 className="label">Assessment Year</h5>
                  <input
                    type="number"
              ...
              <div className="col-sm-12 col-md-12 col-lg-12 col-12 ">
                <label className="single-input-inner style-bg-border">
                  ...
                  <input
                    ...
                    placeholder="Selecting Date"
                    value={dateForRent}
                    onChange={(e) => setDateForRent(e.target.value)}
                  />
                </label>
              </div>
            ) : (
          ...
          >
            ...
            <div className="mb-4 float-left">
              <button
                ...
                onClick={() =>
                  handlePay(property?._id, property?.buildingType)
                }
              >
                Pay Now
              </button>
            ...
            {/* {transaction !== {} && transaction?.addStatus !== true ? (
                <button
                  className="btn btn-base "
                  onClick={(e) => handleSubmit(e)}
                >
            ...
            {/* {error === "result not found" ? (
                <button
                  className="btn btn-danger"
                  onClick={() => handlePay(buildingType)}
                >
                  Pay Now
                </button>
              ) : transaction !== {} &&
                transaction?.addStatus !== true ? (
                <button
                  className="btn btn-base "
                  onClick={(e) => handleSubmit(e)}
                >
    ...
    <>
      <div className="add-property-area pd-top-120">
        <div className="container">
          <div className="col-lg-12 col-md-12 col-sm-12 col-12 main_headings_of_pages">
            <h2 style={{ textAlign: "center" }}>
              {" "}
              {locations.pathname == `/add-property/${types}/Add/null`
                ? "Add Property"
                : "Update Property"}
            </h2>
          </div>
