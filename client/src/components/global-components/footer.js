            ...
            <div className="col-lg-4 col-md-6">
              <div className="widget widget_about">
                ...
                <div className="details">
                  ...
                  <p>
                    <i className="fas fa-map-marker-alt" /> 420 Love Sreet 133/2
                    Mirpur City, Dhaka
                  </p>
                  <p>
                    <i className="fas fa-phone-volume" /> +(066) 19 5017 800 628
                  </p>
                  <p>
                    <i className="fas fa-envelope" /> info.contact@gmail.com
                  </p>
                </div>
              </div>
            </div>
