        ...
        return (
          <div className="row ">
            ...
            <div className="col-sm-6 col-md-6 col-lg-6 col-12">
              <label className="single-input-inner style-bg-border">
                ...
                <Select
                  ...
                  // defaultValue={roomAmenities?.map((item, i) => item)}
                  className="basic-multi-select"
                  classNamePrefix="select"
                  // defaultValue={[
                  // 	RoomAmenities.filter(
                  // 		({ value }) => value === [roomAmenities]
                  // 	),
                  // ]}
                />
              </label>
            ...
            <div className="col-sm-6 col-md-6 col-lg-6 col-12">
              <label className="single-input-inner style-bg-border">
                ...
                <Select
                  ...
                  // defaultValue={bathAmenities?.map((item, i) => item)}
                  // defaultValue={BathRoomAmenities.filter(
                  // 	({ value }) => value === bathAmenities
                  // )}
                  // defaultValue={bathAmenities?.[0]}
                  // defaultValue={[BathRoomAmenities.filter(
                  // 	({ value }) => value === bathAmenities?.[0]
                  // )]}
                  // defaultValue={[
                  // 	BathRoomAmenities.filter(
                  // 		(value, index) =>
                  // 			BathRoomAmenities[index].label !==
                  // 			bathAmenities[index].label
                  // 	).map((value, index) => BathRoomAmenities[index]),
                  // ]}
                  className="basic-multi-select"
                  classNamePrefix="select"
                  // value={BathRoomAmenities.filter(
                  // 	({ value }) => value === bathAmenities
                  // )}
                />
              </label>
            ...
            <div className="col-sm-6 col-md-6 col-lg-6 col-12">
              <label className="single-input-inner style-bg-border">
                <h5 className="label">
                  Flooring<span style={{ color: " #dad6d6" }}>-optional</span>
                </h5>
                <Select
                  isMulti
                  styles={customStyles}
        ...
        return (
          ...
          <label className="single-input-inner style-bg-border">
            ...
            <div className="col-sm-6 col-md-6 col-lg-6 col-12">
              ...
              <label className="single-input-inner style-bg-border">
                <h5 className="label">
                  Front Type<span style={{ color: " #dad6d6" }}>-optional</span>
                </h5>
                <Select
                  styles={customStyles}
            ...
            <div className="col-sm-6 col-md-6 col-lg-6  col-12">
              <label className="single-input-inner style-bg-border">
                ...
                <Select
                  ...
                  isMulti
                  styles={customStyles}
                  onChange={handleSiteAmenities}
                  options={SiteAmenities}
                  defaultValue={siteAmenities}
                  className="basic-multi-select"
                  classNamePrefix="select"
                  borderRadius="20px"
                />
            ...
            <div className="col-sm-6 col-md-6 col-lg-6 col-12">
              <label className="single-input-inner style-bg-border">
                ...
                <Select
                  isMulti
                  styles={customStyles}
                  onChange={handleExteriorConstruction}
                  options={ExteriorConstruction}
                  defaultValue={exteriorConstruction}
                  className="basic-multi-select"
                  classNamePrefix="select"
                />
              </label>
            ...
            {roomDimensions.map((data, index) => (
              <Fragment key={index}>
                ...
                <div className="col-sm-12 col-md-3 col-lg-3 col-12">
                  <label className="single-input-inner style-bg-border">
                    <h5 className="label">
                      Levels<span style={{ color: "red" }}>*</span>
                    </h5>
                    <input
                      type="text"
                      placeholder="levels"
        ...
        <div className="container">
          ...
          <form encType="multipart/form-data">
            <div className="property-form-grid">
              ...
              {/* </Tab> */}
              {/*//.....................Room Dimensions.....................// */}
              {/* <Tab label="Room Dimensions"> */}

              {/* </Tab> */}

              {/*//......................Upload Image....................// */}
              {/* <Tab label="Uploading Image"> */}
