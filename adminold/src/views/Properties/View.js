            ...
            <Tabs isFitted variant="enclosed">
              ...
              <TabPanels>
                ...
                <TabPanel>
                  ...
                  <Feature
                    title="Bath"
                    value={item?.bathAmenities?.map(
                      (items, index) => items?.bathAmenities?.value
                    )}
                    shades="blue.50"
                  />
                  <Feature
                    title="Home Construction"
                    value={item?.constructionMaterial?.map(
                      (items, index) => items?.constructionMaterial?.value
                    )}
                  ...
                  <Feature
                    title="Flooring"
                    value={item?.flooring?.map(
                      (items, index) => items?.flooring?.value
                    )}
                  ...
                  <Feature
                    title="Home"
                    value={item?.homeAmenities?.map(
                      (items, index) => items?.homeAmenities?.value
                    )}
                  ...
                  <Feature
                    title="Room"
                    value={item?.roomAmenities?.map(
                      (items, index) => items?.roomAmenities?.value
                    )}
                    // value={item?.roomAmenities?.value}
                    shades={null}
                  />
                  <Feature
                    title="Kitchen"
                    value={item?.kitchenAmenities?.map(
                      (items, index) => items?.kitchenAmenities?.value
                    )}
                    value={item?.kitchenAmenities?.value}
                    shades="blue.50"
                  />
                  <Feature
                    title="Exterior Construction"
                    value={item?.exteriorConstruction?.map(
                      (items, index) => items?.exteriorConstruction?.value
                    )}
                    value={item?.exteriorConstruction?.value}
                    shades={null}
                  />
                  <Feature
                    title="Neighbouring"
                    value={item?.neighbouringAmenities?.map(
                      (items, index) => items?.neighbouringAmenities?.value
                    )}
                    value={item?.neighbouringAmenities?.value}
                    shades="blue.50"
                  />
                </TabPanel>
              </TabPanels>
