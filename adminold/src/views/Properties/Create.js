          ...
          <DrawerBody>
            ...
            <Box className="col-lg-12 col-12 my-3">
              ...
              >
                <option
                  value="Coast"
                  selected={item?.viewType === "Coast" ? true : false}
                >
                  Stone
                </option>
                <option
                  value="City"
                  selected={item?.viewType === "City" ? true : false}
                >
                  Brick
                </option>
                <option
            ...
            <Box className="col-lg-12 col-12 my-3">
              <FormLabel>Front Type</FormLabel>
              <Select
              ...
              >
                ...
                <option
                  value="Lakefront"
                  selected={item?.frontType === "Lake Front" ? true : false}
                >
                  Lake Front
                </option>
              </Select>
            ...
            <Box className="col-lg-12 col-12 my-3">
              <FormLabel>Choose Site Amenities</FormLabel>
              <MultiSelect
            ...
            <Box className="col-lg-12 col-12 my-3">
              <FormLabel>Exterior Finish</FormLabel>
              <MultiSelect
            ...
            <Box className="col-lg-12 col-12 my-3">
              ...
              >
                <option
                  value="Forced Air"
                  selected={item?.heatingType === "Forced Air" ? true : false}
                >
                  Forced Air
                </option>
                <option
